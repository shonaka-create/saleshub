...
export default function TermsPage() {
  return (
    <article className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
      ...
      <ul className="mt-2 space-y-1">
        <li className={li}>基本プラン: 月額 {BASE_PRICE_JPY}円 (税込) / 人。初月 (登録から1ヶ月間) は無料です。</li>
        <li className={li}>
          早期登録特典: 2026年7月31日までに登録した組織は、登録から3ヶ月間無料でご利用いただけます。
        </li>
        <li className={li}>
          Pro プラン (経営分析・テンプレート機能): 基本プランとは別途、月額490円 (税込) / 人。14日間の無料トライアルがあります (トライアル開始にはクレジットカードの登録が必要で、期間中に解約しない場合はトライアル終了後に自動的に課金が始まります)。
        </li>
